...
--
CREATE DATABASE IF NOT EXISTS `grh_v1` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `grh_v1`;
...
ALTER TABLE `droits_conges`
  ...
  ADD CONSTRAINT `droits_conges_ibfk_2` FOREIGN KEY (`empid`) REFERENCES `employe` (`empid`) ON DELETE CASCADE;
